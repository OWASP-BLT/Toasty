...
from toasty.aibot.aibot_env import configure_and_validate_settings
from toasty.aibot.constants import REPO_PRIVACY_UPDATES, get_installation_state_mapping, get_repo_state_updates
from toasty.aibot.db_models import GithubAppInstallation, GithubAppRepo, InstallationState, RepoState
from toasty.aibot.qdrant_api import q_rename_collection_alias
from toasty.aibot.tasks import (
...
from toasty.aibot.utils import parse_json, sign_payload, validate_github_request, verify_github_signature
from toasty.aibot.validation_schemas import (
...
def handle_installation_event(payload: Dict[str, Any]) -> JsonResponse:
    ...
    elif action in get_installation_state_mapping():
...
def handle_repository_event(payload: Dict[str, Any]) -> JsonResponse:
    ...
    repo_state_updates = get_repo_state_updates()
...
def apply_state_change(
    ...
    installation_state_mapping = get_installation_state_mapping()
